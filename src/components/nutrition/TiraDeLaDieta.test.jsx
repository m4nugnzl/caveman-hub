...
import { TiraDeLaDieta } from './TiraDeLaDieta';

/**
 * ══ Qué protege este archivo ═══════════════════════════════════════════════
 *
 * La cinta es, desde la tanda de «una sola forma de copiar», el sitio donde cae
 ...
 *      llega `null` y la cinta no pregunta a nadie si acepta: es la ley del
...
const pintar = (props) =>
  renderToStaticMarkup(<TiraDeLaDieta dias={dias} activo="d1" onDia={() => {}} {...props} />);
...
describe('la cinta de la dieta como sitio donde cae lo que llevas', () => {
  ...
  it('el día sobre el que se está soltando se enciende, y sigue distinguiéndose del abierto', () => {
    ...
    /* El encendido de recibir y el de «estás aquí» son dos marcas distintas y
       ...
       mirando. */
    expect(html).toContain('tira-eslabon is-drop-target');
    expect(html).toContain('tira-eslabon is-on');
